...
import NutritionForm from "../Nutrition/NutritionForm/NutritionForm";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/nutrition"
            element={
              <NutritionPage user={userGlobal} setUserGlobal={setUserGlobal} />
            }
          />
          <Route
            path="/nutrition/add"
            element={<NutritionForm user={userGlobal} />}
          />
