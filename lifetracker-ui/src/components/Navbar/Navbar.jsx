    ...
    return(
        <div className="Navbar">
            <div className="activity-links">
                ...
                <a className="activity-link" href="/activity">Activity</a>
                <a className="activity-link" href="/exercise">Exercise</a>
                <a className="activity-link" href="/nutrition">Nutrition</a>
                <a className="activity-link" href="/sleep">Sleep</a>
            </div>
